...
// WeightedRandomApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CWeightedRandomAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CWeightedRandomAppApp

CWeightedRandomAppApp::CWeightedRandomAppApp()
{
...
// Единственный объект CWeightedRandomAppApp

CWeightedRandomAppApp theApp;


// Инициализация CWeightedRandomAppApp

BOOL CWeightedRandomAppApp::InitInstance()
{
